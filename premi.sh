...
restart_system() {
    ...
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/yBh1ZaSVDZbWseMP/v3.0lts/main/izin | grep $ipsaya | awk '{print $3}')
    TIMEZONE=$(printf '%(%H:%M:%S)T')
    TEXT="
<code>────────────────────</code>
<b>✨AUTOSCRIPT PREMIUM V3.0 LTS✨</b>
<code>────────────────────</code>
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/yBh1ZaSVDZbWseMP/v3.0lts/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/yBh1ZaSVDZbWseMP/v3.0lts/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/yBh1ZaSVDZbWseMP/v3.0lts/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/yBh1ZaSVDZbWseMP/v3.0lts/main/"
